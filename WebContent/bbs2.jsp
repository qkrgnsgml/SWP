...
<nav class="navbar navbar-default">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  ...
  <div class="container">
   <form  class="navbar-form navbar-left" method="post" action="./bbs2.jsp">
  <div class="form-group">
	<input type="text" class="form-control" width ="60"placeholder="제목" name="title" value = "" maxlength="50">
  </div>
...
<br>
 ...
 <div class="container">
 	<div class="row">
 		...
 		%>
 			<a href="bbs2.jsp?pageNumber=<%=pageNumber+1%>" class="btn btn-success btn-arrow-Left">다음</a>
 		<%
 			}
 		%>
