 	...
 	<div class="row">
 		<table class="table table-striped" style="text-align: center; border:1px solid #dddddd">
 			...
 			<tbody>
 				...
 				<tr>
 					<td >가격</td>
 					<td colspan="2"><%= bbs.getPrice() %>원</td>
 				</tr>
 				<tr>
 					<td >지역</td>
 					<td colspan="2"><a href="map.jsp?location=<%= bbs.getLocation() %>"><%= bbs.getLocation() %></a></td>
 				</tr>
 				<tr>
 					<td >상태</td>
 					<td colspan="2"><%= bbs.getState() %></td>
 				</tr>
 				<tr>
 					<td >이미지</td>
 					<td colspan="2"><img src="upload/<%= bbs.getImg() %>" width=512 height=384 ></img></td>
 				</tr>
 				<tr>
 					<td >내용</td>
 					<td colspan="2" style="min-height:500px; text-align:left"><%= bbs.getBbsContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
 				</tr>
 			</tbody>
 		...
 		%>		
 				...
 				<a href="ingAction2.jsp?bbsID=<%= bbsID%>&title=<%= bbs.getBbsTitle()%>"class="btn btn-primary">거래중</a>
 				<a href="endAction2.jsp?bbsID=<%= bbsID%>&title=<%= bbs.getBbsTitle()%>"class="btn btn-primary">거래완료</a>
