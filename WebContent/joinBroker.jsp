 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  ...
  <ul class="nav navbar-nav navbar-right">
   ...
   <ul class="dropdown-menu">
    ...
    <li class="active"> <a href="joinBroker.jsp">대행가입</a></li>
  ...
  <div class="col-lg-4">
   ...
   <form method="post" action="joinBrokerAction.jsp">
    <h3 style="text-align: center;">대행회원가입화면</h3>
    ...
    <div class="form-group">
     <input type="text" class="form-control" placeholder="지역(동까지)" name="loc" maxlength="50">     
    </div>
